...
namespace Editor
{
	...
	void Editor::Initiate()
	{
		...
		{
			Log(LogType::Error, "SDL Cannot be initiated.");
			return;
		}
		...
		Window = SDL_CreateWindow("SDL_OpenGL", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, Width, Height, SDL_WINDOW_OPENGL | SDL_WINDOW_SHOWN);
	...
	bool Editor::InitiateRenderer()
	{
		...
		EditorUI = std::make_shared(new UI::Editor())
	}
}
